...
export default function PrivacyPolicy() {
    return (
        <section className="max-w-3xl mx-auto py-10 px-6 text-gray-800">
            ...
            <p>We use cookies to enhance your browsing experience. You can manage or disable cookies through your browser settings. For more details, visit our <Link to="/cookie-policy" className="underline text-blue-600">Cookie Policy</Link>.</p>
            ...
            <p>You have the right to access, correct, or delete your personal data. To make a request, please contact us at <a href="mailto:support@prodronesolutions.com" className="underline text-blue-600">support@prodronesolutions.com</a>.</p>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@prodronesolutions.com" className="underline text-blue-600">support@prodronesolutions.com</a>.</p>
        </section>
    );
}
